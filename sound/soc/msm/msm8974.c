...
defined(CONFIG_MACH_KS01KTT) || defined(CONFIG_MACH_KS01LGT)
	...
	.insert_detect = true,
	.swap_gnd_mic = NULL,
#if (defined(CONFIG_MACH_KLTE_KOR) || defined(CONFIG_MACH_KLTE_JPN) || defined(CONFIG_MACH_KACTIVELTE_DCM) || defined(CONFIG_MACH_CHAGALL_KDI)) && !defined(CONFIG_SEC_FACTORY)
...
#endif
#if defined(CONFIG_MACH_KLTE_KOR) || defined(CONFIG_MACH_KLTE_JPN) || defined(CONFIG_MACH_KACTIVELTE_DCM) || defined(CONFIG_MACH_CHAGALL_KDI)
