...
#define DEFUALT_HIGH_THRESHOLD	84
#define DEFUALT_LOW_THRESHOLD	49
#define TBD_HIGH_THRESHOLD	84
#define TBD_LOW_THRESHOLD	49
#define WHITE_HIGH_THRESHOLD	84
#define WHITE_LOW_THRESHOLD	49
#else
